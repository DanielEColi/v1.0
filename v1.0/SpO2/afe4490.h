#ifndef __AFE4490_H__
#define __AFE4490_H__

#include "datatype.h"
#include "global.h"

#if(SAMPLE_100HZ==1)
#define AFE4490_SAMPLE_RATE		100	
#else
#define AFE4490_SAMPLE_RATE		300	
#endif
#define SAMPLE_TIMER_SECOND		6


#define AFE4490_R_INDEX		4
#define AFE4490_IR_INDEX	5

#define AFE4490_CS_LOW 	GPIO_ResetBits(GPIOA, GPIO_Pin_4)	
#define AFE4490_CS_HIGH GPIO_SetBits(GPIOA, GPIO_Pin_4)	

#define AFE4490_SCLK_LOW 	GPIO_ResetBits(GPIOA, GPIO_Pin_5)	
#define AFE4490_SCLK_HIGH GPIO_SetBits(GPIOA, GPIO_Pin_5)	

#define AFE4490_MOSI(status)		GPIO_WriteBit(GPIOA, GPIO_Pin_7, (BitAction)status)
#define READ_AFE4490_MISO				GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_6)

extern bool IsChangeLight;
extern bool IsChangeMin;
extern uint8_t thrflag2;

void WriteCommand(u8 cmd,u32 data);
u32 ReadCommand(u8 cmd);

extern s32 Afe4490DataBuf[6];		//原始采样数据，6个不同信号
...
void ReconfigAfe4490(void);

extern u32 AFE44xx_Current_Register_Settings[64];
...
#define    LEDCNTRL_VAL                (0x021414ul)//200mA
...
#define         CLK_DIV_3               (0x000003ul)            // Div by 6
#define         CLK_DIV_4               (0x000004ul)            // Div by 8
#define         CLK_DIV_5               (0x000005ul)            // Div by 12
#define         CLK_DIV_7               (0x000007ul)            // Div by 1
#define         CLKOUT_TRI              (0x000008ul)            // CLKOUT_TRI
#define         SOMI_TRI                (0x000010ul)            // SOMI_TRI
#define         TX3_MODE                (0x008000ul)            // TX3_Mode
